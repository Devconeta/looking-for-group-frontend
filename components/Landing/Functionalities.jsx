...
const functions = [
...

  {
    ...
    description: [
      "Your party is an evolving entity. By building trough hackathons & dragons, your team will gain experience every time you participate in a code conquest. ",
...
const Functionalities = ({ className }) => {
  return (
    <div className={`${className} w-full h-full bg-black text-white flex flex-col items-center`}>
        ...
        {functions.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col">
              <h3 className="text-[1.9rem] text-primary mb-3 2xl:mb-3.5">{item.title}</h3>
